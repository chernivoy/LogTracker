...
THEME_SETTINGS = {
    ...
    # Плашка — акцентна поверхня теми: той самий синій, що в кнопках і ховері
    # меню, тож підтвердження читається як частина застосунку, а не системне
    # повідомлення. Кегль на пункт менший за текст помилки і жирний — це
