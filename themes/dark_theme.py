...
THEME_SETTINGS = {
    ...
    # = фон вікна» лишається чинним для settings_bg: та смуга живе ВСЕРЕДИНІ
    # вікна, її фон має бути продовженням фону, а не окремим шаром.)
    ...
    # #2b2c2f, який світліший), інакше смуга налаштувань у dark була б помітно
    # світліша за решту вікна. В інших темах main_frame_fg_color конкретний, і
    # settings_bg дорівнює йому. Текст нейтральний, поля темніші за фон, кнопки —
    # синій акцент.
    "settings_bg": "#242424",
