...
class ErrorWindow:
    ...
    def create_widgets(self):
        ...
        # Тут достатньо update_idletasks (застосовує відкладену геометрію);
        # повний root.update() НЕ потрібен — він прокручує всю чергу подій під
        # час побудови вікна, даючи ризик реентрантності. На старті winfo_* ще
        # можуть бути неточні, тож logger.run() повторює цей розрахунок через
        # after(200), коли вікно повністю змаплене.
